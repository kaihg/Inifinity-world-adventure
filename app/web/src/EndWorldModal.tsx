...
// 「封存世界」是操作行為（非遊戲資訊），由 header 操作按鈕開啟此置中對話框確認。
  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="end-world-title"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 id="end-world-title" className="modal-title">結束並封存世界</h2>
        <p className="modal-body">
          確定要結束並封存目前世界嗎？此動作會把整個世界封存到 archives/，並回到世界初始化畫面。
        </p>
