        ...
        <main className="story-col">
          <section className="story-card">
            ...
            <div className="setup-form">
              <label className="modal-field">基調 / 可參考作品<textarea value={tone} disabled={busy} onChange={(e) => setTone(e.target.value)} /></label>
              <label className="modal-field">恐怖 / 驚悚強度<input value={horrorIntensity} disabled={busy} onChange={(e) => setHorrorIntensity(e.target.value)} /></label>
              <label className="modal-field">主神表面性格<input value={godPersona} disabled={busy} onChange={(e) => setGodPersona(e.target.value)} /></label>
              <label className="modal-field">新手保護規則<textarea value={protectionRule} disabled={busy} onChange={(e) => setProtectionRule(e.target.value)} /></label>
              <hr />
              <label className="modal-field">主角姓名<input value={name} disabled={busy} onChange={(e) => setName(e.target.value)} /></label>
              <label className="modal-field">主角出身<textarea value={origin} disabled={busy} onChange={(e) => setOrigin(e.target.value)} /></label>
